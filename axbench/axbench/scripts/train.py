            ...
            if model_name in HAS_SYSTEM_PROMPT_MODELS:
                def apply_chat_template(row):
                    ...
                    if nobos[0] == tokenizer.bos_token_id:
                        nobos = nobos[1:-suffix_length]
                    else:
                        nobos = nobos[:-suffix_length]
...
def main():
    ...
    if "meta-llama/Llama-3.1-".lower() in args.model_name.lower():
    ...
    elif "Qwen2.5-".lower() in args.model_name.lower():
    ...
    model_instance = AutoModelForCausalLM.from_pretrained(
        ...
        load_in_4bit=True if "70b" in args.model_name.lower() else False,
    )
    is_chat_model = True
