    ...
    def train(self, examples, **kwargs):
        ...
        for epoch in range(self.training_args.n_epochs):
            for step, batch in enumerate(train_dataloader):
                ...
                expanded_batch_size = minibatch_size * len(self.preference_pairs)
                ...
                for mb in range(num_minibatches):
                    ...
                    winning_lens = get_lens(minibatch_inputs["labels"][:minibatch_size_actual//2])
                    losing_lens = get_lens(minibatch_inputs["labels"][minibatch_size_actual//2:])
