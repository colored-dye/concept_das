...
class TrainingArgs:
    def __init__(
        ...
        global_params = [
            ...
            'source_tokens', 'do_overwrite_vector',
        ]
        hierarchical_params = [
    ...
    def _infer_type(param_name: str):
        ...
        str_params = [
            ...
            'wandb_project', 'wandb_name', 'steering_prompt_type', 'source_tokens']
